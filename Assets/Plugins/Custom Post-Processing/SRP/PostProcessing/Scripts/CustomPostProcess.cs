...
namespace SRP.PostProcessing
{
    public class CustomPostProcess : ScriptableRendererFeature
    {
        class CustomRenderPass : ScriptableRenderPass
        {
            ...
            const string Tag = "Custom Post Process";
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                using (new ProfilingScope(cmd, new ProfilingSampler(Tag)))
                {
                    ...
                    {
                        if (_cartoonMat == null)
                            _cartoonMat = new Material(Shader.Find("Custom Post-Processing/SRP/Cartoon"));
                    ...
                    else if (_volume is FastBlurVolume fVolume && _volume != null)
                    {
                        if (_fastBlurMat == null)
                            _fastBlurMat = new Material(Shader.Find("Custom Post-Processing/SRP/FastBlur"));
                    ...
                    else if (_volume is ChromaticVolume chVolume && _volume != null)
                    {
                        if (_chromaticMat == null)
                            _chromaticMat = new Material(Shader.Find("Custom Post-Processing/SRP/Chromatic"));
                    ...
                    else if (_volume is SimpleEdgeVolume siVolume && _volume != null)
                    {
                        if (_simpleEdgeMat == null)
                            _simpleEdgeMat = new Material(Shader.Find("Custom Post-Processing/SRP/SimpleEdge"));
                    ...
                    {
                        if (_sketchMat == null)
                            _sketchMat = new Material(Shader.Find("Custom Post-Processing/SRP/Sketch"));
                    ...
                    {
                        if (_glitchMat == null)
                            _glitchMat = new Material(Shader.Find("Custom Post-Processing/SRP/Glitch"));
                    ...
                    {
                        if (_crtMat == null)
                            _crtMat = new Material(Shader.Find("Custom Post-Processing/SRP/CRT"));
                    ...
                    else if (_volume is MonochromeVolume mValue && _volume != null)
                    {
                        if (_monochromeMat == null)
                            _monochromeMat = new Material(Shader.Find("Custom Post-Processing/SRP/Monochrome"));
                    ...
                    else if (_volume is EdgeGlowVolume egVolume && _volume != null)
                    {
                        if (_edgeGlowMat == null)
                            _edgeGlowMat = new Material(Shader.Find("Custom Post-Processing/SRP/EdgeGlow"));
                    ...
                    {
                        if (_vcrMat == null)
                            _vcrMat = new Material(Shader.Find("Custom Post-Processing/SRP/VCR"));
